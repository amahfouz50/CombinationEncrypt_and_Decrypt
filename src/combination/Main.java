...
public class Main extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel13.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/combine.png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (jTextField1.getText().isEmpty()){
            ...
            try {
  combinationcode c=new  combinationcode();
 c.get_plain_text(jTextField1.getText());
                c.create_matrix();
                c.generate_first_arr(0);
             jTextField3.setText(   c.generate_cipher());        
            }catch(Exception e){
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       if (jTextField15.getText().isEmpty()){
            JOptionPane.showMessageDialog(null, "No Cipher Text Found  !");   
                 
        }else {
            try {
  combinationcode c=new  combinationcode();
 c.get_plain_text(jTextField15.getText());
                  c.create_matrix();
                c.generate_first_arr(1);
                
              jTextField3.setText(  c.generate_plain()); 
